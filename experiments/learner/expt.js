...
// can copy this, just to save things
...
// timeline just a list, you add trials to the timeline
var timeline = [];

// nothing preloaded yet, but useful for images later
var preload = {
    type: jsPsychPreload,
    images: ['img/1orange9purple.png']
};
...
var consent = {
    ...
    stimulus: `
        ...
        <p><b>Purpose of the research:</b> To examine how people learn and teach effectively.</p>
        <p><b>What you will do in this research:</b> You will learn the turtle compositions of 
            islands, and select trustworthy teachers along the way.</p>
        <p><b>Time required:</b> This experiment will take ${params.completionMinutes} minutes 
            to complete.</p>
        <p><b>Risks:</b> There are no anticipated risks associated with participating in this study.
            The effects of participating should be comparable to those you would experience from 
            viewing a computer monitor and using a mouse and keyboard for the duration of 
            the experiment.</p>
        <p><b>Benefits:</b> The study provides important information about the nature of 
            teaching.</p>
        <p><b>Compensation:</b> You will receive <b>$${params.basePay}</b> for completing the 
            experiment and a performance bonus of up to <b>$${params.maxBonus}</b>.</p>
        <p><b>Confidentiality:</b> Your participation in this study will remain confidential.
            ...
            projects.</p>
        <p><b>Participation and withdrawal:</b> Your participation in this study is completely 
            voluntary and you may refuse to participate or you may choose to withdraw at any time
            without penalty or loss of benefits to which you are otherwise entitled.</p>
        <p><b>How to contact the researcher:</b> If you have questions or concerns about your
            participation or payment, or want to request a summary of research findings, please 
            contact Alicia Chen, aliciachen@college.harvard.edu.</p>
        <p><b>Whom to contact about your rights in this research:</b> For questions, concerns, 
            suggestions, or complaints that have not been or cannot be addressed by the researcher,
            or to report research-related harm, please contact the Committee on the Use of Human 
            Subjects in Research at Harvard University, 1414 Massachusetts Avenue, Second Floor, 
            Cambridge, MA 02138. Phone: 617-496-2847. Email: cuhs@fas.harvard.edu.</p>
        `,
    choices: ['I consent']
};
...
var instructions = {
    ...
    pages: [
        `<p>Please read the following instructions carefully as there will be a comprehension quiz.
            ...
            instructions, we will repeat them.</p>`,

        `<p>You have just landed on a new archipelago, consisting of many different islands. 
            You’re interested in the turtles living there.</p>
            <div style='width: 900px; overflow: hidden;' class="center">
                <div><img src='img/1orange9purple.png' width="400"></img></div>
            </div>`,
...
// makes combinations of possible trials, randomly orders
