...
ggplot(d.nonseq.means, aes(x = teacher_knowledge, y = empirical_stat, color = student_prior)) + 
    ...
    labs(x = "teacher knowledge", y = "proportion majority color", col = "student prior", title = "one-shot teaching")
```
...
nonseq.mod <- lmer_alt(
       n_majority / n_turtles ~ 1 
                              ...
                              + (1 + student_prior * teacher_knowledge || student_idx), 
        data = d.nonseq,
        family = binomial,
...
ggplot(d.seq.toohigh.means, aes(x = trial_num, y = empirical_stat, color = feedback)) + 
    ...
    theme(aspect.ratio = 1) + 
    geom_hline(yintercept = 0.7, linetype = "dashed") +
  labs(x = "lesson num", y = "proportion majority color", title = "too high")
...
ggplot(d.seq.toolow.means, aes(x = trial_num, y = empirical_stat, color = feedback)) + 
    ...
    theme(aspect.ratio = 1) + 
    geom_hline(yintercept = 0.7, linetype = "dashed") +
  labs(x = "lesson num", y = "proportion majority color", title = "too low")
```
